...
class EdgeMinibatchIterator(object):
    ...
    """ This minibatch iterator iterates over batches of sampled edges(if context_pairs is None) or
    random pairs of co-occuring edges(if context_pairs is not None).
    ...
    def __init__(self, G, id2idx, 
        ...
        # 总和 14755
        print(len([n for n in G.nodes() if not G.node[n]['test'] and not G.node[n]['val']]), 'train nodes') # 9716 train nodes
        print(len([n for n in G.nodes() if G.node[n]['test'] or G.node[n]['val']]), 'test nodes') # 5039 test nodes
    ...
    def batch_feed_dict(self, batch_edges):
        ...
        feed_dict.update({self.placeholders['batch1']: batch1}) # src nodeId
        feed_dict.update({self.placeholders['batch2']: batch2}) # dst nodeId
    ...
    def incremental_val_feed_dict(self, size, iter_num): # TODO: to read
        edge_list = self.val_edges
    ...
    def incremental_embed_feed_dict(self, size, iter_num): # TODO: to read
    ...
    def label_val(self): # TODO: to read
        train_edges = []
        val_edges = []
