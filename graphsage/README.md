...
GCN和GraphSAGE的较量：从源码角度告诉你谁是爸爸 - 阿亮的文章 - 知乎
https://zhuanlan.zhihu.com/p/199251885

基于多任务学习和负反馈的深度召回模型 - 阿里技术的文章 - 知乎
https://zhuanlan.zhihu.com/p/142559090

GraphSAGE 代码解析(一) - unsupervised_train.py
https://www.cnblogs.com/shiyublog/archive/2004/01/13/9819086.html
...
* graphsage_meanpool -- GraphSage with mean-pooling aggregator (a variant of the pooling aggregator, where the element-wise mean replaces the element-wise max).
